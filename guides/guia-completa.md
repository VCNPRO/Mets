...
4. [🆕 Templates Regionales](#-templates-regionales)
5. [Secciones del Formulario](#secciones-del-formulario)
6. [Analizador de Archivos](#analizador-de-archivos)
7. [🆕 Análisis con Inteligencia Artificial](#análisis-con-inteligencia-artificial)
8. [🆕 Biblioteca de Archivos](#biblioteca-de-archivos)
9. [🆕 Exportación de Metadatos](#exportación-de-metadatos)
10. [Validación XML](#validación-xml)
